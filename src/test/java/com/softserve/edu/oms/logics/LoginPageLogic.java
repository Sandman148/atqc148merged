...
public class LoginPageLogic {
	...
	public SupervisorHomePageLogic successSupervisorLogin(IUser supervisorUser) {
			setLoginData(supervisorUser);
			return new SupervisorHomePageLogic(new SupervisorHomePage());
		}
